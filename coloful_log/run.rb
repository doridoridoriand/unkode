...
(1..255).to_a.map {|n|
  puts "\e[38;5;#{n}mああああああああああああああああああああああああああああああああああああああああああああ\e[0m 38;5;#{n}"
  sleep(0.5)
}
...
(1..8).to_a.map {|set|
  ((31..37).to_a << 39 << (90..97).to_a).flatten.map {|txt|
    ((40..47).to_a << 49 << (100..107).to_a).flatten.map {|bg|
      puts "\e[#{set};#{txt};#{bg}mああああああああああああああああああああああああああああああああああああああああああああ\e[0m #{set};#{txt};#{bg}"
      sleep(0.5)
    }
  }
}
